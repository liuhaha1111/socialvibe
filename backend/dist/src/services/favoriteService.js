...
export async function listMyFavorites(authUserId, email) {
...
export async function addFavorite(authUserId, activityId, email) {
    const profile = await ensureProfileForAuthUser(authUserId, email);
    try {
...
export async function removeFavorite(authUserId, activityId, email) {
    const profile = await ensureProfileForAuthUser(authUserId, email);
